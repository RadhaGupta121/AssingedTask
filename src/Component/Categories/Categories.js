                ...
                <h1 className=" text-3xl font-semibold font-serif">Popular Categories</h1><br/>
                    ...
                    <table className="table">
                        <tr>
                            ...
                            <td className="border-2 px-6 py-4 border-gray-300">Jewellery</td>
                        </tr>
                        <tr>
                            ...
                            <td className="border-2 px-6 py-4 border-gray-300">Beauty</td>
                        </tr>
                        <tr>
                            ...
                            <td className="border-2 px-6 py-4 border-gray-300">Travel</td>
                        </tr>
                        <tr>
                            ...
                            <td className="border-2 px-6 py-4 border-gray-300">Lifestyle</td>
                        </tr>
                        <tr>
                            ...
                            <td className="border-2 px-6 py-4 border-gray-300">Hotel</td>
                        </tr>
                        <tr>
                            ...
                            <td className="border-2 px-6 py-4 border-gray-300">Furniture</td>
                        </tr>
                        <tr>
                            ...
                            <td className="border-2 px-6 py-4 border-gray-300">Novelties</td>
                        </tr>
